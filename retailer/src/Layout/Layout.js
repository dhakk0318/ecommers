...
//       {/* Sidebar */}
//       <div className={`fixed top-0 left-0 h-full w-64 ${isDarkMode ? 'bg-gray-800' : 'bg-white'} shadow-md z-50`}>
//         <Sidebar />
//       </div>

//       <div className="flex-1 ml-64">
//         {/* Header */}
//         <header className={`fixed top-0 left-64 right-0 h-16 ${isDarkMode ? 'bg-gray-900' : 'bg-white'} shadow-md z-50`}>
//           <Header />
//         </header>

//         {/* Main Content */}
//         <main className="p-0 py-14">
